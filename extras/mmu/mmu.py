...
#########################
    ...
    def _calibrate_bowden_length_manual(self, approx_bowden_length, save=True):
        try:
            if self.extruder_homing_endstop == self.ENDSTOP_EXTRUDER_ENTRY and not self.sensor_manager.check_sensor(self.extruder_homing_endstop):
